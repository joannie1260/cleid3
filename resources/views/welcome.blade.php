        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="mt-4">
                <div class="grid grid-cols-1 md:grid-cols-1 gap-6 lg:gap-8">
                    ...
                    <div class="flex justify-center">
                        <iframe width="720" height="405" src="https://www.youtube-nocookie.com/embed/xaaRKlfdjw0"
                            title="Video Stratego" frameborder="0"
                            allow="autoplay;"
                            allowfullscreen></iframe>
                    </div>


                    <a href="https://www.id-3.net/rdv/"
                        class="scale-100 p-6 bg-white ligth:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none flex motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                        <div>

                            <h2 class="mt-6 text-xl font-semibold text-gray-900 light:text-white">Prendre rendez-vous
                                avec un conseiller
                            </h2>

                            <p class="mt-4 text-gray-500 dark:text-gray-400 text-sm leading-relaxed">
                                Générez de nouvelles ventes grâce à notre stratégie de capture et maturation de
                                prospects.
                                Vendre votre propriété le plus rapidement possible et au meilleur prix.
                            </p>
                        </div>
